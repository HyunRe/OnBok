...
public class CompanySearchStrategy extends BookSearchStrategy {
    public CompanySearchStrategy(BookRepository bookRepository) {
        super(bookRepository);
    }

    @Override
    public Page<Book> search(String query, Pageable pageable) {
        return bookRepository.findByCompanyContaining(query, pageable);
    }
}
